...
export const routingComponents = [HeaderComponent, NavigationComponent, FooterComponent, BodyComponent, MainComponent, LetiskoNitraComponent, OnasComponent, LeteckaSkolaComponent];
